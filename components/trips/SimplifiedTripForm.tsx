        ...
        <View className="bg-gray-900 rounded-xl p-6 w-full max-w-md">
          ...
          <View className="space-y-6">
            ...
            <View style={{ marginBottom: 16 }}>
              ...
              <View
                className={`border rounded-lg overflow-hidden ${form.car_id ? 'bg-gray-800 border-green-500' : 'bg-gray-900 border-gray-700'
                  }`}
                style={{
                  opacity: form.car_id ? 1 : 0.75,
                }}
              >
                <Picker
            ...
            <TouchableOpacity
              onPress={handleNext}
              disabled={!canSubmit}
              className={`rounded-lg py-3 ${canSubmit ? 'bg-main' : 'bg-gray-300'
                } items-center`}
            >
